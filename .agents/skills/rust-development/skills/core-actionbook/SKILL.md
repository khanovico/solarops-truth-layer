...
description: Internal actionbook helper for Rust development skills. Use only when explicitly invoked to look up pre-computed browser automation selectors and action manuals.
