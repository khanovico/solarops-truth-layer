...
description: Internal dynamic skill management helper for Rust development skills. Use only when explicitly invoked to sync, clean, or update generated crate-specific Rust skills from Cargo dependencies.
# Command-based tool - implicit invocation disabled in agents/openai.yaml
