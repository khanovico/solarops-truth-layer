...
description: Internal maintenance helper for Rust development skills. Use only when explicitly invoked to check or repair missing reference documentation in generated crate skills.
# Internal maintenance tool - implicit invocation disabled in agents/openai.yaml
