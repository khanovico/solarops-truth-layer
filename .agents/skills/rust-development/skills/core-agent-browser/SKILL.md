...
description: Internal browser automation helper for Rust development skills. Use only when explicitly invoked by another Rust skill or when direct agent-browser CLI navigation, snapshots, screenshots, or form interactions are required.
# Internal tool - implicit invocation disabled in agents/openai.yaml
